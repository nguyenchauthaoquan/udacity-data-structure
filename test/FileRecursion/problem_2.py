...
class MyTestCase(unittest.TestCase):
    ...
    def test_edge_case_2(self):
        self.assertEqual(self.file_rec.find_files(suffix='c', path=self.absolute_path), {os.getcwd() + '/testdir\\subdir1\\a.c',
    ...
    def test_edge_case_3(self):
        """
         Tests the File Recursion for absolute file path case
        """
        self.assertEqual(self.file_rec.find_files(suffix='h', path=self.absolute_path), {os.getcwd() + '/testdir\\subdir1\\a.h',
    ...
    def test_edge_case_5(self):
        ...
        Tests the File Recursion for relative file path case
        """
        self.assertEqual(self.file_rec.find_files(suffix='c', path=self.relative_path), {'./testdir\\subdir1\\a.c',
    ...
    def test_edge_case_6(self):
        ...
        Tests the File Recursion for relative file path case
        """
        self.assertEqual(self.file_rec.find_files(suffix='h', path=self.relative_path), {'./testdir\\subdir1\\a.h',
